...
$text["punchykill"] = "Punchy kills p/m";
$text["mostpunchy"] = "Most Punchy kills per map";
$text["balooney"] = "Balooney Pitcher";
$text["balooneykill"] = "Ballooney kills p/m";
$text["mostbalooney"] = "Most Ballooney kills per map";
$text["betty"] = "Betty SharpShooter";
$text["bettykill"] = "Betty kills p/m";
$text["mostbetty"] = "Most Betty kills per map";
$text["lazy"] = "Lazy Larry";
$text["duckkill"] = "Killer Duck kills p/m";
$text["mostlazy"] = "Most Killer Ducks kills per map";
$text["cldweapon"] = "Cold weapon fan";
$text["knifekill"] = "Knife kills p/m";
$text["mostknife"] = "Most knife kills per map";
$text["bashking"] = "Bash King";
$text["bashes"] = "Bashes p/m";
$text["mostbash"] = "Most bash kills per map";
$text["supersniper"] = "Super Sniper";
$text["skills"] = "Kills p/m";
$text["mostsniper"] = "Most sniper kills per map";
$text["clscombat"] = "Close Combat Pistol Hero";
$text["mostpistol"] = "Most pistol kills per map";
$text["nadekiller"] = "Nade killer";
$text["nadekill"] = "Nade kills p/m";
$text["mostnade"] = "Most nade kills per map";
$text["remotebomb"] = "Remote bomb fan";
$text["c4kill"] = "C4 Kills p/m";
$text["mostc4"] = "Most C4 kills per map";
$text["surpriselover"] = "Surprise lover";
$text["claymorekill"] = "Claymore kills p/m";
$text["mostclaymore"] = "Most Claymore kills per map";
...
$text["pdeaths"] = "Deaths per map";
$text["target1"] = "Target no. 1";
$text["eyeshot"] = "Eyes Wide Shut!";
$text["teamkil"] = "Teamkills";
$text["pteamkil"] = "Teamkills p/m";
$text["mostteamkill"] = "Most Teamkills per map";
$text["sendjoey"] = "Send Joey, he'll do anything!";
$text["teamdeth"] = "Teamdeaths";
$text["pteamdeth"] = "Teamdeaths p/m";
$text["mosteamdeth"] = "Most Teamdeaths per map";
$text["mmnades"] = "Mmmm nades!";
$text["nadedeth"] = "Nade deaths p/m";
$text["mostnadeth"] = "Most nade deaths per map";
...
$text["mostpunchy"] = "Most Punchy deaths per map";
$text["needbaloon"] = "Need Balloons!";
$text["balonydeath"] = "Ballooney deaths p/m";
$text["mostbalondeth"] = "Most Ballooney deaths per map";
$text["bettytarget"] = "Bettys Target";
$text["bettydeath"] = "Betty deaths p/m";
$text["mostbetydeth"] = "Most Betty deaths per map";
$text["ihateducks"] = "I hate Ducks!";
$text["duckdeath"] = "Killerducks deaths p/m";
$text["mostduckdeth"] = "Most Killerducks deaths per map";
$text["mechanic"] = "Mechanic";
$text["vehicledeth"] = "Deaths by vehicle p/m";
$text["mostcardeath"] = "Most deaths by exploding vehicle per map";
$text["shaveme"] = "Shave me please!";
$text["knifedeath"] = "Knife deaths p/m";
$text["mostknifedeth"] = "Most knife deaths per map";
$text["hitme"] = "Hit me please!";
$text["bashdeath"] = "Bash deaths p/m";
$text["mostbashdeth"] = "Most bash deaths per map";
$text["targtpract"] = "Target Practice!";
$text["sniperdeath"] = "Sniper deaths p/m";
$text["mostsniped"] = "Most sniper deaths per map";
$text["accidenthero"] = "Accidental Hero";
$text["blindasbat"] = "Blind as a Bat";
$text["mostaccdeath"] = "Most accidental deaths per map";
