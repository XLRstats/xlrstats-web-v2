...
function tag_start_simple($parser, $attr, $params)
{
  if($attr == 'CLIENT')
  {
    ...
    $clients[$params['SCORE'] + $params['CID']] = new client ($params['DBID'], $params['NAME'], $params['COLORNAME'],$params['LEVEL'], $params['CONNECTIONS'], $params['SCORE'], $params['CID'], $params['GUID'], $params['PBID'], $params['TEAM'], $params['STATE'], $params['IP']);
  }   
}
...
function tag_start($parser, $attr, $params)
{
  ...
  if($attr == 'CLIENT')
  {
    ...
    {
      $clientsSpec[$params['SCORE'] + $params['CID']] = new client ($params['DBID'], $params['NAME'], $params['COLORNAME'],$params['LEVEL'], $params['CONNECTIONS'], $params['SCORE'], $params['CID'], $params['GUID'], $params['PBID'], $params['TEAM'], $params['STATE'], $params['IP']);
    }
    else
    {
      if($params['TEAM'] == 2)
        $clientsRed[$params['SCORE'] + $params['CID']] = new client ($params['DBID'], $params['NAME'], $params['COLORNAME'],$params['LEVEL'], $params['CONNECTIONS'], $params['SCORE'], $params['CID'], $params['GUID'], $params['PBID'], $params['TEAM'], $params['STATE'], $params['IP']);
  
      if($params['TEAM'] == 3)
        $clientsBlue[$params['SCORE'] + $params['CID']] = new client ($params['DBID'], $params['NAME'], $params['COLORNAME'],$params['LEVEL'], $params['CONNECTIONS'], $params['SCORE'], $params['CID'], $params['GUID'], $params['PBID'], $params['TEAM'], $params['STATE'], $params['IP']);
