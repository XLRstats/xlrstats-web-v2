...
$text["punchykill"] = "Punchy kills";
$text["mostpunchy"] = "Most Punchy kills";
$text["balooney"] = "Balooney Pitcher";
$text["balooneykill"] = "Ballooney kills";
$text["mostbalooney"] = "Most Ballooney kills";
$text["betty"] = "Betty SharpShooter";
$text["bettykill"] = "Betty kills";
$text["mostbetty"] = "Most Betty kills";
$text["lazy"] = "Lazy Larry";
$text["duckkill"] = "Killer Duck kills";
$text["mostlazy"] = "Most Killer Ducks kills";
$text["cldweapon"] = "Cold weapon fan";
$text["knifekill"] = "Knife kills";
$text["mostknife"] = "Most knife kills";
$text["bashking"] = "Bash King";
$text["bashes"] = "Bashes";
$text["mostbash"] = "Most bash kills";
$text["supersniper"] = "Super Sniper";
$text["mostsniper"] = "Most sniper kills";
$text["clscombat"] = "Close Combat Pistol Hero";
$text["mostpistol"] = "Most pistol kills";
$text["nadekiller"] = "Nade killer";
$text["nadekill"] = "Nade kills";
$text["mostnade"] = "Most nade kills";
$text["remotebomb"] = "Remote bomb fan";
$text["c4kill"] = "C4 Kills";
$text["mostc4"] = "Most C4 kills";
$text["surpriselover"] = "Surprise lover";
$text["claymorekill"] = "Claymore kills";
$text["mostclaymore"] = "Most Claymore kills";
...
$text["mostteamkill"] = "Most Teamkills";
$text["sendjoey"] = "Send Joey, he'll do anything!";
$text["teamdeth"] = "Teamdeaths";
$text["mosteamdeth"] = "Most Teamdeaths";
$text["mmnades"] = "Mmmm nades!";
$text["nadedeth"] = "Nade deaths";
$text["mostnadeth"] = "Most nade deaths";
$text["needpractice"] = "Needs some practice";
$text["highlosstrk"] = "Higher losestreak";
$text["punchme"] = "Punch me Now!";
$text["punchdeath"] = "Punchy deaths";
$text["mostpunchy"] = "Most Punchy deaths";
$text["needbaloon"] = "Need Balloons!";
$text["balonydeath"] = "Ballooney deaths";
$text["mostbalondeth"] = "Most Ballooney deaths";
$text["bettytarget"] = "Bettys Target";
$text["bettydeath"] = "Betty deaths";
$text["mostbetydeth"] = "Most Betty deaths";
$text["ihateducks"] = "I hate Ducks!";
$text["duckdeath"] = "Killerducks deaths";
$text["mostduckdeth"] = "Most Killerducks deaths";
$text["mechanic"] = "Mechanic";
$text["vehicledeth"] = "Deaths by vehicle";
$text["mostcardeath"] = "Most deaths by exploding vehicle";
$text["shaveme"] = "Shave me please!";
$text["knifedeath"] = "Knife deaths";
$text["mostknifedeth"] = "Most knife deaths";
$text["hitme"] = "Hit me please!";
$text["bashdeath"] = "Bash deaths";
$text["mostbashdeth"] = "Most bash deaths";
$text["targtpract"] = "Target Practice!";
$text["sniperdeath"] = "Sniper deaths";
$text["mostsniped"] = "Most sniper deaths";
$text["accidenthero"] = "Accidental Hero";
$text["blindasbat"] = "Blind as a Bat";
$text["mostaccdeath"] = "Most accidental deaths";
